                           ...
                           <div class="row owner-details border-top border-divider mb-3 pt-2 px-4 px-md-0">
                              ...
                              <div class="col-md-6 mb-3">
                                 <p class="pro-text">
                                    ...
                                    <span class="dark full-mob">Finance Option:</span>
                                     ...
                                     @if($product->type_certified!=null)
                                        ...
                                        @if($product->type_certified=="Y")
                                           ...
                                           <div class="d-flex">
                                            ...
                                            @elseif($product->type_certified=="N")
                                                 <li>
                                               <div class="d-flex">
                                         ...
                                         @else
                                             <li>
                                               <div class="d-flex">
                                                  Type Certified : <div class="col-6 light">&nbsp;Not Known</div>
                                               </div>
                                         </li>
                                            @endif

 ...
 <div class="col-md-12">
                 <div class="card">
                  <div class="card-header">
                    <h5 class="card-text">Subscription Package Add</h5>
                  </div>
                  <div class="card-body">
                ...
                @endif
                       <form  method="post" action="{{route('subscription_package.save')}}" enctype="multipart/form-data">
                        @csrf
                ...
                <div class="row mb-3">
                  <label for="" class="col-sm-12 col-form-label">Products&nbsp;<span style="color:red">*</span></label>
                  <div class="col-sm-12">
                    <input type="text" class="form-control" name="products" required min="0" step="1" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                  </div>
                </div>

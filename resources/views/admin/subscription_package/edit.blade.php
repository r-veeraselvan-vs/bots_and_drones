...
@section('content')
 <div class="col-md-12">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-12">
                    <input type="text" class="form-control" name="type" value="{{$subscription_package->type}}">
                  </div>
                 </div>
                 ...
                 <div class="row mb-3">
                  ...
                  <div class="col-sm-12">
                    <input type="text" class="form-control" name="products" value="{{$subscription_package->products}}">
                  </div>
                 </div>

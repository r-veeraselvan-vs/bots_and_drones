...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <h5 class="card-text">Add Notification</h5>
        </div>
        <div class="card-body">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-12">
                            <label class="radio-inline">
                                <input type="radio" name="publish_option" value="now" checked onchange="toggleDateTimeFields()"> Now
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="publish_option" value="later" onchange="toggleDateTimeFields()"> Later
                            </label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6" id="start-date-time" style="display: none;">

 ...
 <div class="col-md-12">
                 <div class="card">
                  <div class="card-header">
                    <h5 class="card-text">Training Centers Update</h5>
                  </div>
                  <div class="card-body">
                ...
                @endif
                       <form  method="post" action="{{route('training.centers.update')}}">
                        @csrf
                        <input type="hidden" name="id" class="form-control" value="{{$center->id}}" required>
                        <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                    <input type="email" name="email" class="form-control" value="{{$center->email}}" required>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">Mobile No&nbsp;<span style="color:red">*</span></label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="mobile_no" name="mobile_no"  value="{{$center->mobile_no}}" maxlength="15" required>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">City/Town&nbsp;<span style="color:red">*</span></label>
                  <div class="col-sm-8">
                    <input type="text" value="{{$center->location}}" class="form-control" name="location" required>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">Courses&nbsp;<span style="color:red">*</span></label>
                  <div class="col-sm-8">
                     <select class="selectpicker" multiple data-live-search="true" name="courses[]">
                 ...
                 <?php 
                      ...
                      $service = \App\TrainingCourse::whereIn('id',$myArray)->pluck('name')->toArray();

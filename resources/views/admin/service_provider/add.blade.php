 ...
 <div class="col-md-12">
                 <div class="card">
                  <div class="card-header">
                    <h5 class="card-text">Service Provider Add</h5>
                  </div>
                  <div class="card-body">
                ...
                @endif
                       <form  method="post" action="{{route('service.provider.save')}}">
                        @csrf
                        <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-8">
                     <select class="selectpicker" multiple data-live-search="true" name="services[]" required>

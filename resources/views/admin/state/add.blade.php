 ...
 <div class="col-md-12">
                 <div class="card">
                  <div class="card-header">
                    <h5 class="card-text">State Add</h5>
                  </div>
                  <div class="card-body">
                ...
                @endif
                       <form  method="post" action="{{route('state.save')}}" enctype="multipart/form-data">
                        @csrf
                ...
                <div class="row mb-3" align="center">
                  <div class="col-sm-12">
                    ...
                    <a  class="btn btn-danger"  href="{{route('state.list')}}" style="padding: 10px 50px 10px 50px;">Cancel</a>
                  </div>
             </form>
                     </div>
                  </div>

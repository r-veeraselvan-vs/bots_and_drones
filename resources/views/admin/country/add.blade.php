 ...
 <div class="col-md-12">
                 <div class="card">
                  <div class="card-header">
                    <h5 class="card-text">Country Add</h5>
                  </div>
                  <div class="card-body">
                ...
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-12 col-form-label">Symbol&nbsp;<span style="color:red">*</span></label>
                  <div class="col-sm-12">
                ...
                <div class="row mb-3" align="center">
                  <div class="col-sm-12">
                    ...
                    <a  class="btn btn-danger"  href="{{route('country.list')}}" style="padding: 10px 50px 10px 50px;">Cancel</a>
                  </div>
             </form>
                     </div>
                  </div>

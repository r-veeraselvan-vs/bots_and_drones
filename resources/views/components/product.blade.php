                ...
                <div class="sort-select-container">
                  <select name="" id="sort" class="form-select sort-select"   onchange="filter()">
                    ...
                    ?>
                      ...
                      <option value="asc"  @if('asc' == $sorted) selected @endif>Price GBP : Low to High</option>
                     <option value="desc"  @if('desc' == $sorted) selected @endif>Price GBP : High to Low</option>
                  </select>
                </div>
              </div>
            </div>

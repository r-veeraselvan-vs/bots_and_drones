 ...
 <span class="icon"><i class="fas fa-minus"></i></span> 
              ...
              <div class="filter-block">
                ...
                >
                  ...
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="type_certified" id="type_certified3" value="NA"  onclick="filter()">
                    <label class="form-check-label" for="type_certified3">
                      Not Known
                    </label>
                </div>
                </div>

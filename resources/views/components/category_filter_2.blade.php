            ...
            <!-- Start of product filter -->
              ...
              <div class="filter-block">
                ...
                <div class="form-check">
                 ...
                 <div class="form-check">
                    <input class="form-check-input" type="radio" name="uas_category" id="uas_category4" value="Medium"  onclick="filter()">
                    <label class="form-check-label" for="uas_category4">
                      Medium
                    </label>
                </div>
                 <div class="form-check">
                    <input class="form-check-input" type="radio" name="uas_category" id="uas_category5" value="Large"  onclick="filter()">

                ...
                <div class="card-body">
                        ...
                        <div id="seller-details">
                          ...
                          <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                <p>{{$user->trading_name}}</p>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="registered_number" class="col-md-4 col-form-label text-md-right">Registration / Tax Number</label>
                                <div class="col-md-6">
                              ...
                              <div class="row mb-3">
                                <label for="registered_address" class="col-md-4 col-form-label text-md-right">City / Town</label>
                                <div class="col-md-6">
                                <p>{{$user->city}}</p>
                                </div>
                            </div>
                             <div class="row mb-3">
                              ...
                              <div class="row mb-3">
                                <label for="registered_address" class="col-md-4 col-form-label text-md-right">Province / State</label>
                                <div class="col-md-6">
                                <p>{{$user->state}}</p>
                                </div>
                            </div>
                              <div class="row mb-3">
                                <label for="website_link" class="col-md-4 col-form-label text-md-right">Website</label>
                                <div class="col-md-6">
                                <p>
                        ...
                        <div class="row mb-3">
                            <label for="mobile_no" class="col-md-4 col-form-label text-md-right">{{ __('Phone') }}</label>

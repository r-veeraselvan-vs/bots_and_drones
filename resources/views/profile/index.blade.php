                ...
                <div class="card-body">
                        ...
                        <div id="seller-details">
                            ...
                            <div class="row mb-3">
                              ...
                              <div class="row mb-3">
                                <label for="registered_address" class="col-md-4 col-form-label text-md-right">State</label>
                                <div class="col-md-6">
                                <p>{{$user->state}}</p>
                                </div>
                            </div>
                             <div class="row mb-3">
                                <label for="registered_address" class="col-md-4 col-form-label text-md-right">Pincode</label>
                                <div class="col-md-6">
                                <p>{{$user->pincode}}</p>
                                </div>
                            </div>

                            ...
                            <div class="row mb-3">
                             ...
                             <div class="row mb-3">
                              ...
                              <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                <label for="pincode" class="col-md-4 col-form-label text-md-right">Post Code</label>
                                <div class="col-md-6">
                                    <input id="pincode" type="text" class="form-control" name="pincode" value="{{ $user->pincode }}" onkeypress="return /[a-zA-Z0-9,+ ]/i.test(event.key)"  maxlength="8">
                                </div>
                            </div>
                            <div class="row mb-3">

...
<div class="alert alert-success alert-dismissible"  id="successOtpAuth" style="display: none;">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
     ...
     <div class="row mb-3">
        <label for="pincode" class="col-md-4 col-form-label text-md-right">Pincode&nbsp;<span class="text-danger">*</span></label>
        <div class="col-md-6">
            <input id="pincode" type="text" class="form-control" name="pincode" onkeypress="return /[0-9,+ ]/i.test(event.key)"  maxlength="7" required>
        </div>
    </div>
      <div class="row mb-3">
    ...
    <div class="row mb-3">
        <label for="registered_number" class="col-md-4 col-form-label text-md-right">GST Number&nbsp;<span class="text-danger">*</span></label>
        <div class="col-md-6">
    ...
    Your password must be 8-20 characters.
                        ...
                        <div class="row mb-3" >
                         ...
                         <div class="row mb-3" >
                            <label for="mobile_no" class="col-md-4 col-form-label text-md-right">{{ __('Contact Mobile No') }}&nbsp;<span class="text-danger">*</span> </label>
  ...
  <input id="checkbox" type="checkbox"  onchange="document.getElementById('register').disabled = !this.checked;" />
   I have read and accept the <a href="https://botsanddrones.in/terms-and-conditions" target="_blank">terms &
conditions</a> and <a href="https://botsanddrones.in/privacy-policy" target="_blank">privacy policy.</a></label>      
  </span>
</div> </div></div>

...
<div class="alert alert-success alert-dismissible"  id="successOtpAuth" style="display: none;">
  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-6">
            <div class="input-group mb-3">
                                      <input id="company_phone" type="text" class="form-control @error('company_phone') is-invalid @enderror" onkeypress="return /[0-9,+ ]/i.test(event.key)" maxlength="15" name="company_phone" value="{{ old('company_phone') }}" required>
                                </div>
        </div>
                         <div class="row mb-3" >
                            <label for="company_phone" class="col-md-4 col-form-label text-md-right"><span class="text-danger"></span></label>
                            <div class="col-md-6">
                                <small id="passwordHelpBlock" class="form-text text-muted">&nbsp&nbsp&nbspE.g.+911234567890</small>
                            </div>
                        </div>
    </div>
    ...
    <div class="row mb-3">
        <label for="address" class="col-md-4 col-form-label text-md-right"><b>Registered Address:</b>&nbsp;</label>
        <div class="col-md-6">
     ...
     <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="pincode" type="text" class="form-control" name="pincode" maxlength="10" required>
        </div>
    </div>
      <div class="row mb-3">
    ...
    <div class="row mb-3">
            <label for="website_link" class="col-md-4 col-form-label text-md-right">{{ __('Website') }}&nbsp;<span class="text-danger">*</span></label>
            <div class="col-md-6">
                <input id="website_link" type="url" class="form-control" name="website_link" required autofocus>

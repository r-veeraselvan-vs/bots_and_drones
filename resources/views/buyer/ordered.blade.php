...
<div class="d-md-none">
   ...
   @endif
    ...
    <div class="d-flex">
       <b>Country : </b>
        <p class="ml-5" style="margin-left: 10px;"> {{$user->country}}</p>
   ...
   <div class="d-flex">
       ...
       @if($product->pricing_request=="N")
        <p class="ml-5" style="margin-left: 10px;">{{$product->price}}</p> 
        @else
     ...
     <div class="d-flex">
       <b>Finance : </b>
        ...
        <p class="ml-5" style="margin-left: 10px;">Available</p>
        @else 
        <p class="ml-5" style="margin-left: 10px;">Not Available</p>
        @endif
  ...
  <label for="checkbox">I have read and accept the <a href="https://botsanddrones.in/terms-and-conditions" target="_blank">terms &

                            ...
                            <div class="form-group row"><label for="" class="col-md-4 col-form-label text-md-left"></label><div class="col-md-6 text-center" id="recaptcha-container"></div></div></br>
                                ...
                                <div class="form-group row">
                                    <label for="country" class="col-md-4 col-form-label text-md-left">Country&nbsp;<span class="text-danger">*</span></label>
                                        <div class="col-md-6">
                                            @if ($user->country_id)
                                                <input id="country_id" type="text" class="form-control" name="country_id" value="{{ $user->countries->name }}" readonly required>   
                                            @else
                                                <input id="country_id" type="text" class="form-control" name="country_id" value="Country Not Found" readonly required>
                                            @endif 
                                        </div>
                                </div>
                            <br/>
                                    ...
                                    <label for="price" class="col-md-4 col-form-label text-md-left">Price</label>
                                        <div class="col-md-6">
                                            @if($product->pricing_request=="N")
                                                <input type="text" class="form-control" value="USD ${{$product->usd_price}} @if(!empty($product->price)){{$symbol}}{{$product->price}}@endif" readonly>
                                                @else
  ...
  <span class="popuptext" id="myPopup">Not a company ? Enter Individual</span>
                            ...
                            <br/>
                                <div class="form-group row">
                                    ...
                                    @if ($country)
                                        <div class="col-md-6">
                                            <input id="buyer_country" type="text" class="form-control " name="country" value="{{$country->name}}" readonly required>    
                                        </div>
                                    @else
                                        <div class="col-md-6">
                                            <input id="buyer_country" type="text" class="form-control " name="country" value="Country not found" readonly required>    
                                        </div>
                                    @endif
                                </div>
                            <br/>
                            ...
                            <br/>
                                <div class="form-group row">
                                  <?php
                                   $productUserId = $product['user_id'];
                                   $selleruser = App\Models\User::find($productUserId);
                                   $userCountryId = $selleruser ? $selleruser->country_id : null;
                                   $country = App\Models\Countries::find($userCountryId);
                                   if ($country && $country->symbol) {
                                       $symbol = $country->currency_symbol . ' ' . $country->symbol;
                                   } else {

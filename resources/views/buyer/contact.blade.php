...
<div class="container" style="margin-top: 10px;">
                    ...
                    <div class="col-md-8" style="padding-top:10px;padding-bottom:20px;background-color:white">
                      <div class="card-body">
                       ...
                       <form method="POST"  action="{{route('contact.add')}}"    style="margin-top:50px">
                            ...
                            <br/>
                                <div class="form-group row">
                                    <label for="finance" class="col-md-4 col-form-label text-md-left">Finance  </label>
                                        <div class="col-md-6">
                                            @if($product->finance=="Lease")
                                            <input id="finance" type="text" class="form-control" name="finance" value="Available" required readonly> 
                                            @else 
                                            <input id="finance" type="text" class="form-control" name="finance" value="Not Available" required readonly>
                                            @endif  
                                        </div>
                                </div>
                            <br/>
                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-md-left">Finance Required&nbsp;<span class="text-danger">*</span></label>
                                    <div class="col-md-6">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="finance_required" id="finance_required_yes" value="yes" required>
                                            <label class="form-check-label" for="finance_required_yes">Yes</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="finance_required" id="finance_required_no" value="no">
                                            <label class="form-check-label" for="finance_required_no">No</label>
                                        </div>
                                    </div>
                                </div>
                            <br/>
  ...
  </div>   <div class="form-group row"><label for="" class="col-md-4 col-form-label text-md-left"></label><div class="col-md-6 text-center" id="recaptcha-container"></div></div>

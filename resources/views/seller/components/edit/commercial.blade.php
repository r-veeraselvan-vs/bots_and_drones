                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="checkbox" name="commercial_gst_included"  @if($product->gst_included=="Y") checked @endif>&nbsp;&nbsp;Inclusive of GST
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select id="uas_category" type="text" class="form-select" name="commercial_uas_category"  required>
                                            ...
                                            <option value="Medium" @if("Medium" == $product->uas_category) selected @endif>Medium</option>
                                            <option value="Large" @if("Large" == $product->uas_category) selected @endif>Large</option>
                                        </select>
                            ...
                            <div class="row justify-content-around">
                                <div class="col-md-12 mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <textarea id="package_items" type="text" class="form-control" name="commercial_package_items"  autofocus>{{$product->package_items}}</textarea>

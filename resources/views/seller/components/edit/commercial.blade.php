                            ...
                            <div class="row">
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="commercial_usd_price" type="text" class="form-control" name="commercial_usd_price" value="{{ $product->usd_price }}" onkeypress="return /^[0-9.,]+$/.test(event.key)" autofocus>
                                        <br>
                                        <input type="checkbox" name="commercial_pricing_request" @if($product->pricing_request=="Y") checked @endif>&nbsp;&nbsp;Price on Request
                                        <br>
                                        <input type="checkbox" name="commercial_gst_included" @if($product->gst_included=="Y") checked @endif>&nbsp;&nbsp;Inclusive of Taxes
                                        <br>
                                        <input type="checkbox" id="commercial_local_price" name="commercial_local_price" onchange="togglePriceInput(this)" @if($product->price != 0) checked @endif>&nbsp;&nbsp;Price in&nbsp;&nbsp;<span><?php echo $symbol; ?></span>
                                        <br>
                                        <div id="commercial_price_wrapper" @if(empty($product->price)) style="display:none;" @endif>
                                            <div class="col-md-12 mt-2">
                                                <input id="commercial_price" type="text" class="form-control" name="commercial_price" value="{{ $product->price }}" onkeypress="return /^[0-9.,]+$/.test(event.key)">
                                            </div>
                                        </div>
                                        <script>
                                            function togglePriceInput(checkbox) {
                                                var priceWrapper = document.getElementById('commercial_price_wrapper');
                                                var priceInput = document.getElementById('commercial_price');
                                                if (checkbox.checked) {
                               ...
                               <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                           ...
                                           <input  type="text" id="commercial_brand"  class="form-control mt-3" name="commercial_brand" value="{{ $product->brand }}" required>
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" id="commercial_model_name"  class="form-control mt-3" name="commercial_model_name" value="{{ $product->model_name }}" required>
                            ...
                            <!-- <div class="col-md-6 mb-3">
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                            <input  type="text" id="commercial_location"  class="form-control" name="commercial_location" value="{{$product->location}}" >
                                        @error('location')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>

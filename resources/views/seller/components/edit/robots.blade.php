<div class="row justify-content-center">
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    ?>
                                    <label for="robots_usd_price" class="col-md-4 col-form-label text-md-right">{{ __('Price in USD') }}<span class="text-danger">*</span></label>
                                    <div class="col-md-8">
                                        <input id="robots_usd_price" type="text" class="form-control" name="robots_usd_price" value="{{ $product->usd_price }}" onkeypress="return /^[0-9.,]+$/.test(event.key)" autofocus>
                                        <br>
                                        <input type="checkbox" name="robots_pricing_request" @if($product->pricing_request=="Y") checked @endif>&nbsp;&nbsp;Price on Request
                                        <br>
                                        <input type="checkbox" name="robots_gst_included" @if($product->gst_included=="Y") checked @endif>&nbsp;&nbsp;Inclusive of Taxes
                                        <br>
                                        <input type="checkbox" id="robots_local_price" name="robots_local_price" onchange="togglePriceInput(this)" @if($product->price != 0) checked @endif>&nbsp;&nbsp;Price in&nbsp;&nbsp;<span><?php echo $symbol; ?></span>
                                        <br>
                                        <div id="robots_price_wrapper" @if(empty($product->price)) style="display:none;" @endif>
                                            <div class="col-md-12 mt-2">
                                                <input id="robots_price" type="text" class="form-control" name="robots_price" value="{{ $product->price }}" onkeypress="return /^[0-9.,]+$/.test(event.key)">
                                            </div>
                                        </div>
                                        <script>
                                            function togglePriceInput(checkbox) {
                                                var priceWrapper = document.getElementById('robots_price_wrapper');
                                                var priceInput = document.getElementById('robots_price');
                                                if (checkbox.checked) {
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        ?>
                                        <input type="hidden" name="robots_country" id="robots_country" class="form-control" value="{{ $countries->id }}" readonly>
                                        <input type="text" name="robots_country_name" id="robots_country_name" class="form-control" value="{{ $countries->name }}" readonly>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="col-md-6 mb-3">
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input  type="text" id="robots_location"  class="form-control" name="robots_location" value="{{$product->location}}" >
                                    </div>
                                </div>
                            </div>
                        </div>
                                   ...
                                   <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <select id="engine_type"  class="form-select" name="robots_engine_type"  required>
                                            ...
                                            <option value="Fuel + Electric"  @if("Fuel + Electric" == $product->engine_type) selected @endif>Fuel + Electric</option>
                                            <option value="Solar + Electric"  @if("Solar + Electric" == $product->engine_type) selected @endif>Solar + Electric</option>
                                        </select>
                                    </div>
                                </div>
                               </div>

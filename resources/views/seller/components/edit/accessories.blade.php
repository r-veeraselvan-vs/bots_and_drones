                            ...
                            <div class="row">
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="price" type="text" class="form-control" name="accessories_price" value="{{ $product->price }}" onkeypress="return /^[0-9.,]+$/.test(event.key)"  required>
                                        <br><input type="checkbox" name="accessories_pricing_request"   @if($product->pricing_request=="Y") checked @endif>&nbsp;&nbsp;Price on Request <br>
                                        <input type="checkbox" name="accessories_gst_included"    @if($product->gst_included=="Y") checked @endif>&nbsp;&nbsp;Inclusive of VAT    
                                    </div>
                                </div>
                            </div>
                             <div class="col-md-6 mb-3">
...
<!-- new fields -->
                            <div class="col-md-6 mb-3 ">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="accessories_compatible_with" type="text" class="form-control" name="accessories_compatible_with" value="{{ $product->compatible_with }}"  required>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="accessories_country" id="country" class="form-select" required>
                            ...
                            <div class="col-md-6 mb-3">
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="accessories_location" id="accessories_location" class="form-select" value="{{ old('accessories_location') }}" onchange="accessoriesOtherlocation(this.value)" required>

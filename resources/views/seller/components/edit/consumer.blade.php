<div class="row justify-content-center">
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    <label for="consumer_price" class="col-md-4 col-form-label text-md-right">{{ __('Price GBP (£)') }}<span class="text-danger">*</span></label>

                                    <div class="col-md-8">
                                        <input id="consumer_price" type="text" class="form-control" name="consumer_price" value="{{ $product->price }}" onkeypress="return /^[0-9.,]+$/.test(event.key)"   required>
                                         <br><input type="checkbox" name="consumer_pricing_request"  @if($product->pricing_request=="Y") checked @endif>&nbsp;&nbsp;Price on Request <br>
                                    <input type="checkbox" name="consumer_gst_included"   @if($product->gst_included=="Y") checked @endif>&nbsp;&nbsp;Inclusive of VAT
                                    </div>
                                </div>
                            </div>
                             <div class="col-md-6 mb-3">
                             ...
                             <div class="col-md-6 mb-3 ">
                               ...
                               <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select id="consumer_brand" type="text" class="form-select" name="consumer_brand" value="{{ old('consumer_brand') }}" onchange="consumerOtherbrand(this.value)" required>
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select id="consumer_model_name" type="text" class="form-select" name="consumer_model_name" value="{{ old('consumer_model_name') }}"  onchange="consumerOtherModel(this.value)" required>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="consumer_country" id="consumer_country" class="form-select" required>
                          ...
                          <div class="row">
                               <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="consumer_location" id="consumer_location" class="form-select" value="{{ old('consumer_location') }}" onchange="consumerOtherlocation(this.value)" required>

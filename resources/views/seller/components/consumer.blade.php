<div class="row justify-content-center">
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <input type="checkbox" name="consumer_gst_included" value="Y">&nbsp;&nbsp;Inclusive of GST
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 d-flex align-items-center">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="consumer_method" id="enquiry_radio" value="Contact Seller"  checked>

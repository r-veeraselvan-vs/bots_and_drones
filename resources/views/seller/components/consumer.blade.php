<div class="row justify-content-center">
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <br><input type="checkbox" name="consumer_pricing_request" value="Y">&nbsp;&nbsp;Price on Request <br>
                                    <input type="checkbox" name="consumer_gst_included" value="Y">&nbsp;&nbsp;Inclusive of VAT
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                               ...
                               <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input  type="text" id="consumer_other_brand"  class="form-control mt-3" name="consumer_other_brand"  style="display:none">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <input  type="text" id="consumer_other_location"  class="form-control mt-3" name="consumer_other_location" value="{{ old('consumer_other_location') }}" style="display:none" autofocus>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">

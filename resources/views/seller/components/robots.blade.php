<div class="row justify-content-center ">
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="robots_usd_price" type="text" class="form-control" name="robots_usd_price" value="{{ old('usd_price') }}" onkeypress="return /^[0-9.,]+$/.test(event.key)" autofocus>
                                        <br>
                                        <input type="checkbox" name="robots_pricing_request" value="Y">&nbsp;&nbsp;Price on Request 
                                        <br>
                                        <input type="checkbox" name="robots_gst_included" value="Y">&nbsp;&nbsp;Inclusive of Taxes
                                        <br>
                                        <input type="checkbox" id="robots_local_price" name="robots_local_price" onchange="toggleWrapper(this, 'robots_price_wrapper')">&nbsp;&nbsp;Price in</span>&nbsp;&nbsp;<span><?php echo $symbol; ?></span>
                                        <br>
                                        <div id="robots_price_wrapper" style="display:none;">
                                            <div class="col-md-12 mt-2">
                                                <input id="robots_price" type="text" class="form-control" name="robots_price" value="{{ old('price') }}" onkeypress="return /^[0-9.,]+$/.test(event.key)" autofocus>
                                            </div>
                                        </div>
                                        <script>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                    <input  type="text" id="robots_location"  class="form-control" name="robots_location" value="{{ old('robots_location') }}" >
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 d-flex align-items-center">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="robots_method" id="enquiry_radio" value="Contact Seller" required checked>

<div class="row justify-content-center">
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="price" type="text" class="form-control" name="accessories_price" value="{{ old('price') }}"  onkeypress="return /^[0-9.,]+$/.test(event.key)"  autofocus>
                                        <br><input type="checkbox" name="accessories_pricing_request" value="Y">&nbsp;&nbsp;Price on request <br>
<input type="checkbox" name="accessories_gst_included" value="Y">&nbsp;&nbsp;Inclusive of GST
                                    </div>
                                </div>
                            </div>
                             <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3 ">
                                <div class="row">
                                    <label for="accessories_finance" class="col-md-4 col-form-label text-md-right">{{ __('Finance') }}<span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="accessories_country" id="country" class="form-select" >
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="accessories_location" id="accessories_location" class="form-select" value="{{ old('accessories_location') }}" onchange="accessoriesOtherlocation(this.value)" >
                                            <option value="">Select City</option>
                                            <option value="Other">Other</option>
                                        </select>
                                    <input  type="text" id="accessories_other_location"  class="form-control mt-3" name="accessories_other_location" value="{{ old('accessories_other_location') }}" style="display:none">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 d-flex align-items-center">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="accessories_method" id="enquiry_radio" value="Contact Seller"  checked>

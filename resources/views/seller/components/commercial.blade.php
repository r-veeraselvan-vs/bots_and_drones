<div class="row justify-content-center">
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="checkbox" name="commercial_gst_included" value="Y">&nbsp;&nbsp;Inclusive of VAT
                                    </div>
                                </div>
                            </div>
                              <div class="col-md-6 mb-3">
                             ...
                             <div class="col-md-6 mb-3 ">
                               ...
                               <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select id="commercial_brand" type="text" class="form-select" name="commercial_brand" value="0"  onchange="commercialOtherbrand(this.value)">
                             ...
                             <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                          <select id="commercial_model_name" type="text" class="form-select" name="commercial_model_name" value="{{ old('commercial_model_name') }}"  onchange="commercialOtherModel(this.value)">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="commercial_country" id="country" class="form-select" >
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select name="location" id="location" class="form-select" value="{{ old('location') }}" onchange="commercialOtherlocation(this.value)" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        <select id="propulsion" type="text" class="form-select" name="propulsion">
                                            <option value="">Select Power<span class="text-danger">*</span></option>

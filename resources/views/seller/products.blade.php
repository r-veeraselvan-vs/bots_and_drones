        ...
        <div class="col-md-3">
            <div class="card">
              ...
              ?>
                    ...
                    @if($state!=null)
                        <p class="card-text" ><span style="color:red"><span><?php echo $symbol; ?></span> {{$product->price}}</span><span style="text-align: right;float: right;color:black"><i class="fa fa-map-marker"></i> {{$product->location}}<br>{{$state->name}}</span></p>
                    @endif
                    <br>

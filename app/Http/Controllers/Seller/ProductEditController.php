...
class ProductEditController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $new->usd_price = $request->consumer_usd_price;
        $new->brand = $brand;
    ...
    public function updateCommercial(Request $request)
    {
        ...
        if($request->commercial_location=="Other")
        {
            $New = new City();
        ...
        $new->usd_price = $request->commercial_usd_price;
        $new->brand = $brand;
        $new->model_name = $model;
    ...
    public function updateAccessories(Request $request)
    {
        ...
        $new->usd_price = $request->accessories_usd_price;
    ...
    public function updateRobots(Request $request)
    {
        ...
        $new->usd_price = $request->robots_usd_price;
